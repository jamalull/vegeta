        ...
        >
          <div className="w-[900px] p-[52px] flex gap-[67px]">
            <div className="flex flex-col flex-1 justify-between">
              ...
              <Input
                className="w-[100%] p-4 font-normal placeholder:tracking-wide placeholder:italic"
                type="text"
                placeholder="Masukkan alamat email (ex: hi@vegeta.test)"
                prefix="Envelope"
              />
              <Input
                className="w-[100%] p-4 font-normal placeholder:tracking-wide placeholder:italic"
                type="text"
                placeholder="Masukkan nomor telepon (ex: 081234567891)"
                prefix="Call"
              />
